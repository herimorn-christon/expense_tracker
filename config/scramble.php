...
return [
    ...
    'info' => [
        ...
        /*
         * API title. App name is used when this config is `null`.
         */
    ...
    'security_schemes' => [
        'bearerAuth' => [
            'type' => 'http',
            'scheme' => 'bearer',
            'description' => 'Enter your Sanctum token in the format: Bearer {your_token_here}'
        ]
    ],
    ...
    'security_schemes' => [
        'sanctum' => [
            ...
            'in' => 'header',
            'name' => 'Authorization',
            'description' => 'Enter: Bearer {token} or just {token}'
        ]
    ],
